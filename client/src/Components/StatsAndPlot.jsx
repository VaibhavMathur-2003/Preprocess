...
const StatsAndPlot = ({ headers, stats, correlationHeatmap, plotType, setPlotType, xColumn, setXColumn, yColumn, setYColumn, hue, setHue, plot, handlePlot, handlePrevious }) => (
  <div>
